...
b_r = 0.15
b_list = [[img_read("bird_0_0",b_r), img_read("bird_0_1",b_r),img_read("bird_0_2",b_r),img_read("bird_0_3",b_r)],
          [img_read("bird_1_0",b_r), img_read("bird_1_1",b_r),img_read("bird_1_2",b_r),img_read("bird_1_3",b_r)],
          [img_read("bird_2_0",b_r), img_read("bird_2_1",b_r),img_read("bird_2_2",b_r),img_read("bird_2_3",b_r)]]
class person:
    def __init__(self):
